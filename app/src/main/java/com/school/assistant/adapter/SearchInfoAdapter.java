package com.school.assistant.adapter;
...
import com.school.assistant.databinding.SearchInfoBinding;
...
public class SearchInfoAdapter extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        com.school.assistant.databinding.SearchInfoBinding searchInfoBinding;
        if (view == null) {
