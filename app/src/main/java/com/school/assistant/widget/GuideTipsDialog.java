package com.school.assistant.widget;
...
import com.school.assistant.core.http.api.ApiService;
import com.school.assistant.core.http.callback.NoTipCallBack;
import com.school.assistant.core.http.entity.TipInfo;
import com.school.assistant.utils.MMKVUtils;
...
public class GuideTipsDialog extends BaseDialog implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    private static final String KEY_IS_IGNORE_TIPS = "com.school.assistant.widget.key_is_ignore_tips_";
